...
from torch.cuda.amp import custom_fwd, custom_bwd  # PyTorch 2.1.0 的正确导入路径
import math
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("❌ Triton 未安装，请运行: pip install triton")
        exit(1)
    ...
    if device.type == "cuda":
        ...
        print(f"GPU 内存: {torch.cuda.get_device_properties(device).total_memory / 1024**3:.2f} GB")
